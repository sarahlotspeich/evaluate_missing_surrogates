...
## Source data generation function (surrogate distributions do not overlap)
devtools::source_url("https://raw.githubusercontent.com/sarahlotspeich/evaluate_missing_surrogates/refs/heads/main/gen.data.non.overlap.R")
...
for (r in 1:REPS) {
  # Generate data 
  data = gen.data.non.overlap(n1 = n1, 
                              n0 = n0) 
  ...
  ## Save 
  sim_res |> 
    write.csv(paste0("sett5_non_overlap_seed.csv"), 
              row.names = FALSE)
}
